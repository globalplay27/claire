...
${campaignBrief}
KPI principal: aumentar seguidores qualificados no Instagram. META OPERACIONAL: buscar dobrar a base de seguidores em até 28 dias, sem prometer o resultado ao público. Priorize ideias que gerem compartilhamentos, salvamentos, visitas ao perfil, curiosidade recorrente e motivo claro para seguir. Venda direta, preço e conversão são secundários nesta fase.
